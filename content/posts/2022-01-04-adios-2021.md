...
to [Hugo+Github](https://github.com/justb4/justobjects.nl), using GitHub Workflows to "publish-on-commit". My first piece of GitOps, more to follow, in 2021.
...
Yes, it happened! In between COVID-Waves a LOC lead by the great [Erik Meerburg](https://www.linkedin.com/in/erikmeerburg/) achieved to organize 
...
{{< a-img data-href="https://foss4g.nl/" data-src="/uploads/2022/foss4gnl/group-photo.jpg" data-caption="Group Photo FOSS4G-NL 2021" >}}
...
* Episode 14: [Newyear with QGIS-NL and OpenStreetMap-NL communities](https://www.youtube.com/watch?v=WNowA03zQSo). 
* Episode 15: [OpenStreetMap Special](https://youtu.be/nhlIqMyBIig). Special guest: Ilya Zverev a.k.a. [Zverik](https://wiki.openstreetmap.org/wiki/User:Zverik)!
* Episode 16: [GIS with your Keyboard](https://youtu.be/iOiliIAorD4)
* Episode 17: [On Geospatial Databases](https://youtu.be/caOn96p3cYQ)
* Episode 18: [Cartography Special](https://youtu.be/8bPvPFFVlg8)
* Episode 19: [Ten Years of OSGeo.nl - Story in Pictures](https://youtu.be/yMAxQEg0fSw)

{{< a-img data-href="https://youtu.be/iOiliIAorD4" data-src="/uploads/2022/dggs/gis-keyboard.jpg" data-caption="Episode 16 - GIS with your Keyboard"  >}}
...
* [FastAPI-Users starter Template repo](https://github.com/justb4/fastapi-users-starter) - adding full user management to FastAPI.
...
Ongoing in 2021. In progress of moving all to Github Workflows build/push, replacing DockerHub Autobuild (still awaiting DockerHub Open Source waiver...):
...
Not as much fun as in 2019 Bukarest, but providing the Geopython Workshop at FOSS4G Buenos Aires with these great minds
