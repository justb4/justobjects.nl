...
It should be noted and credited that most of the OGC 3D standards came out of the German [GDI-DE][5] project.  
...
Although [OSGeo.org][6] is not a standards body, for years the Tiled Map Service TMS spec is intensively used, probably more than its OGC-counterpart WMTS&#8230;  
...
More: <http://www.ifcwiki.org/index.php/Main_Page>
